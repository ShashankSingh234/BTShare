    ...
    public class AcceptThread : Thread
    {
        ...
        public AcceptThread(BluetoothChatService service, bool secure)
        {
            ...
            try
            {
                if (secure)
                {
                    tmp = service.btAdapter.ListenUsingRfcommWithServiceRecord(Constants.NAME_SECURE, Constants.MY_UUID_SECURE);
                }
                else
                {
                    tmp = service.btAdapter.ListenUsingInsecureRfcommWithServiceRecord(Constants.NAME_INSECURE, Constants.MY_UUID_INSECURE);
                }
